...
class Agent:  
    ...
    def get_loss(self, states, actions, rewards, dones, next_states):         
        ...
        Advantages  = self.policy_function.generalized_advantage_estimation(values, rewards, next_values, dones).detach()
        Returns     = self.policy_function.temporal_difference(rewards, next_values, dones).detach()
