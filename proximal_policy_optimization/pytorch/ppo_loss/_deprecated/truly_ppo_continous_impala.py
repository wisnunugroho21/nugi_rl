...
def get_loss(action_mean, worker_action_mean, old_action_mean, values, old_values, next_values, actions, rewards, dones,
        ...
        Worker_logprobs = logprob(worker_action_mean, action_std, actions).detach()  
        ...
        ratios      = (logprobs - Old_logprobs).exp() * (logprobs - Worker_logprobs).exp() # ratios = old_logprobs / logprobs        
