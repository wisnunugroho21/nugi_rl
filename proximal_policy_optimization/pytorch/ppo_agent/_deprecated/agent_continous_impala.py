...
class AgentContinous(AgentImpala):
    ...
    def act(self, state):
        ...
        return to_numpy(action.squeeze(0), self.use_gpu), to_numpy(action_mean.squeeze(0), self.use_gpu)

    # Get loss and Do backpropagation
    def training_ppo(self, states, actions, rewards, dones, next_states, worker_action_mean): 
        ...
        loss = get_loss(action_mean, worker_action_mean, old_action_mean, values, old_values, next_values, actions, rewards, dones,
