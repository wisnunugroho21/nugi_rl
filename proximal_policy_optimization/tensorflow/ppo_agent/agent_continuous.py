...
from distribution.multi_normal_distribution import sample

class Agent:  
    def __init__(self, action_dim, is_training_mode = True, policy_kl_range = 0.03, policy_params = 5, value_clip = 1.0, entropy_coef = 0.0, vf_loss_coef = 1.0,
                 minibatch = 32, PPO_epochs = 10, gamma = 0.99, lam = 0.95, learning_rate = 3e-4, action_std = 1.0, folder = 'model'):        
