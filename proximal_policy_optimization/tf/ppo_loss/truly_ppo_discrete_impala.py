...
# Loss for PPO  
def get_loss(action_probs, worker_action_probs, old_action_probs, values, old_values, next_values, actions, rewards, dones,
        ...
        Worker_logprobs = tf.stop_gradient(logprob(worker_action_probs, actions))   
        ...
        Kl              = kldivergence(old_action_probs, action_probs) + kldivergence(worker_action_probs, action_probs)
