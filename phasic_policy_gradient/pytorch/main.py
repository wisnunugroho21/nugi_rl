...
from distribution.beta_continous import BasicContinous
from loss.joint_aux import JointAux
from loss.truly_ppo import TrulyPPO
from model.Carla import Policy_Model, Value_Model
...
Policy_Memory   = ImageStateMemory
...
# ray.init()
runner      = Runner(Wrapper, render, training_mode, n_update, Wrapper.is_discrete(), agent, max_action, None, n_plot_batch) # [Runner.remote(i_env, render, training_mode, n_update, Wrapper.is_discrete(), agent, max_action, None, n_plot_batch) for i_env in env]
