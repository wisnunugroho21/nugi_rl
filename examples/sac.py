...
policy              = Policy_Model(state_dim, action_dim).float().to(set_device(use_gpu))
...
agent = AgentSAC(soft_q1, soft_q2, policy, value, policy_dist, q_loss, policy_loss, value_loss, memory, 
