...
from loss.v_mpo.discrete_alpha_loss import AlphaLoss
...
from model.v_mpo.SoftmaxNN import Policy_Model, Value_Model
...
runner      = PongRunner(agent, environment, is_training_mode, render, n_update, environment.is_discrete, max_action, SummaryWriter(), n_plot_batch)
