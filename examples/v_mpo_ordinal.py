...
from nugi_rl.loss.v_mpo.alpha.discrete_alpha_loss import DiscreteAlphaLoss
...
from nugi_rl.model.v_mpo.SigmoidNN import Policy_Model, Value_Model
...
environment         = DiscretizationGymWrapper(env)
...
alpha_loss          = DiscreteAlphaLoss(distribution, coef_alpha_upper, coef_alpha_below)
...
policy              = Policy_Model(state_dim, action_dim, bins).to(device)
