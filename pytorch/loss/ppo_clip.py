...
class PPOClip():
    def __init__(self, device, policy_clip = 0.2, value_clip = 1.0, vf_loss_coef = 1.0, entropy_coef = 0.01, action_std = 1.0, gamma = 0.99, lam = 0.95):
        ...
        self.advantagefunction  = AdvantageFunction(gamma, lam)
