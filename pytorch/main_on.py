...
from eps_runner.on_policy.carla import CarlaRunner
...
from model.ppg.Carla import Policy_Model, Value_Model
from memory.on_policy.image_state_on_policy_memory import ImageStatePolicyMemory
from memory.other.image_state_aux_memory import ImageStateAuxMemory
# from memory.other.image_state_clr_memory import ImageStateClrMemory 
...
Aux_loss        = JointAux
# Clr_loss        = CLR
Wrapper         = CarlaEnv(im_height = 240, im_width = 240, im_preview = False, max_step = 512)
Policy_Memory   = ImageStatePolicyMemory
Aux_Memory      = ImageStateAuxMemory
# Clr_Memory      = ImageStateClrMemory
