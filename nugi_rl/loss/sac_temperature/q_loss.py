...
class QLoss(nn.Module):
    def __init__(self, distribution: Distribution, gamma: int = 0.99):
        super().__init__()
        
        self.gamma          = gamma
        self.distribution   = distribution

    def forward(self, predicted_q1: Tensor, predicted_q2: Tensor, target_next_q1: Tensor, target_next_q2: Tensor, next_action_datas: tuple, next_actions: Tensor, 
        reward: Tensor, done: Tensor, alpha: Tensor) -> Tensor:
