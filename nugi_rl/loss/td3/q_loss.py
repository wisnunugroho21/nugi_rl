...
class QLoss():
    ...
    def compute_loss(self, predicted_q_value1, naive_predicted_q_value1, predicted_q_value2, naive_predicted_q_value2, target_next_q1, target_next_q2, reward, done):
        ...
        q_value_loss1           = ((target_q_value - predicted_q_value1).pow(2) * 0.5)
        q_value_loss2           = ((target_q_value - predicted_q_value2).pow(2) * 0.5)
        
        return (q_value_loss1 + q_value_loss2 + cql_regularizer).mean()