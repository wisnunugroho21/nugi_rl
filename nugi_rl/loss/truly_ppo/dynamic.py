...
class TrulyPPODynamic():
    ...
    def compute_loss(self, action_datas, old_action_datas, values, old_values, next_values, actions, rewards, dones, alpha, beta):
        ...
        pg_targets      = ratios * advantages - (self.policy_params * Kl + alpha * (Kl - self.policy_kl_range) + beta * ratios)        
