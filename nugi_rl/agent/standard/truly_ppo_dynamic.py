...
class AgentTrulyPPODynamic():  
    ...
    def _training(self, states, actions, rewards, dones, next_states): 
        ...
        action_datas, alpha, beta   = self.policy(states)
        ...
        loss = self.ppoLoss.compute_loss(action_datas, old_action_datas, values, old_values, next_values, actions, rewards, dones, alpha, beta)
