...
class AgentPPO(Agent):  
    def __init__(self, policy: Module, value: Module, distribution: Distribution, ppo_loss: PPO, memory: Memory, optimizer: Optimizer, 
        ppo_epochs: int = 10, is_training_mode: bool = True, batch_size: int = 32, folder: str = 'model', device: device = torch.device('cuda:0'), 
        policy_old: Module = None, value_old: Module = None):   
